...
<body>
  ...
  <div class="swiper-container laptop" id="slider">
    <div class="swiper-wrapper">
      <div class="swiper-slide"><img alt="sliderimage1" id="image1" src="assets/img/bg/bg.jpg" /></div>
      <div class="swiper-slide"><img alt="sliderimage1" id="image1" src="assets/img/bg/bg3.jpg" /></div>
      <div class="swiper-slide"><img alt="sliderimage1" id="image1" src="assets/img/bg/bg5.jpg" /></div>
  ...
  <div class="swiper-container mobile" id="slider">
    <div class="swiper-wrapper">
      <div class="swiper-slide"><img alt="sliderimage1" id="image1" src="assets/img/bg/bg7.jpg" /></div>
      <div class="swiper-slide"><img alt="sliderimage1" id="image1" src="assets/img/bg/bg8.jpg" /></div>
      <div class="swiper-slide"><img alt="sliderimage1" id="image1" src="assets/img/bg/bg9.jpg" /></div>
